...
The current release is 1.3.4.  See `changelogs/changelog-1.3.4.md`_ for details.
...
According to the Scala versioning policy, the library can be used in projects with any Scala-3 version.
 ...
 .. code-block:: scala
   ...
   libraryDependencies += "io.github.dotty-cps-async" %%% "dotty-cps-async-next" % "1.3.4"
...
for sbt:
 ...
 .. code-block:: scala
  ...
  addCompilerPlugin(
   ("io.github.dotty-cps-async" %% "dotty-cps-async-compiler-plugin" % "1.3.4")
...
for mill:
 ...
 .. code-block:: scala
  ...
  def scalacPluginIvyDeps = Agg(
        ivy"io.github.dotty-cps-async:::dotty-cps-async-compiler-plugin:1.3.4")
...
To enable one, add `dotty-cps-async-loom` module to the dependencies:
 ...
 .. code-block:: scala
   ...
   libraryDependencies += "io.github.dotty-cps-async" %% "dotty-cps-async-loom" % "1.3.4"
 ...
 .. code-block:: scala
   ...
   // for next line
   libraryDependencies += "io.github.dotty-cps-async" %% "dotty-cps-async-loom-next" % "1.3.4"
...
.. _changelogs/changelog-1.3.4.md: changelogs/changelog-1.3.4.md
